...
const navigationItems: NavItem[] = [
  ...
  { name: 'Savings', href: '/savings', icon: WalletIcon, roles: ['PLAYER', 'PRO', 'CADDY'] },
  { name: 'Loans', href: '/loans', icon: DocumentTextIcon, roles: ['PLAYER', 'PRO', 'CADDY'] },
  { name: 'Wallet', href: '/wallet', icon: WalletIcon, roles: ['PLAYER', 'PRO', 'CADDY'] },
  { name: 'Transactions', href: '/transactions', icon: DocumentTextIcon, roles: ['PLAYER', 'PRO', 'CADDY'] },
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center gap-3 px-6 py-8 border-b border-primary/20">
            ...
            <div>
              ...
              <p className="text-xs text-text/50 capitalize">{user?.role || 'Member'}</p>
            </div>
          </div>
            ...
            {filteredNavItems.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {isActive && <span className="ml-auto w-1.5 h-8 rounded-full bg-primary" />}
                </Link>
              );
            })}
          </nav>
