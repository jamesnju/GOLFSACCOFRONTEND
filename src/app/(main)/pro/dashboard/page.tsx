    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="bg-gradient-to-br from-secondary/20 to-secondary/5 border-secondary/30">
          <div className="space-y-2">
            <p className="text-sm text-text/60">Students/Training</p>
        ...
        <Card className="bg-gradient-to-br from-accent/20 to-accent/5 border-accent/30">
          <div className="space-y-2">
            <p className="text-sm text-text/60">Earnings</p>
...
import { getCurrentUser } from '@/lib/auth/auth.actions';import { Loader } from '@/components/ui/Loader/Loader';
