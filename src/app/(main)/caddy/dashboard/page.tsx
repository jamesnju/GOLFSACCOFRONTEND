    ...
    <div className="space-y-8">
      ...
      <div>
        <h1 className="text-3xl font-bold text-text">
          Welcome back, Caddy {user?.firstName}! 🏌️
        </h1>
        <p className="text-text/60 mt-1">Manage your caddy finances and services</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="bg-gradient-to-br from-secondary/20 to-secondary/5 border-secondary/30">
          <div className="space-y-2">
            <p className="text-sm text-text/60">Services</p>
            <p className="text-3xl font-bold text-secondary">0</p>
            <p className="text-xs text-text/40">Upcoming features</p>
          </div>
        </Card>

        <Card className="bg-gradient-to-br from-accent/20 to-accent/5 border-accent/30">
          <div className="space-y-2">
            <p className="text-sm text-text/60">Tips</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card className="border-primary/20">
          ...
          <Suspense fallback={<Loader size="sm" />}>
            {/* Add RecentTransactions component here if needed */}
